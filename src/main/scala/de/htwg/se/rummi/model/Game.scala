...
import de.htwg.se.rummi.Const.MINIMUM_POINTS_FIRST_ROUND
...
case class Game(activePlayer: Player,
  ...
  def this(activePlayer: Player,
           ...
           playerParticipations: List[PlayerParticipation],
           id: Int) {
    this(activePlayer, field, coveredTiles, playerParticipations, Turn.empty(activePlayer), id, GameState.WAITING)
  }
