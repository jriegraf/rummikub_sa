...
import de.htwg.se.rummi.RummiModule
import de.htwg.se.rummi.controller.ControllerInterface
import de.htwg.se.rummi.controller.GameState._
...
class Controller @Inject()() extends ControllerInterface {
  ...
  def switchPlayer(game: Game): Try[Game] = {
    ...
    gameController.setActivePlayer(game, playerController.getNextActivePlayer(game)) match {
